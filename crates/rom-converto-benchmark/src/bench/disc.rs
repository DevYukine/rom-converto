//! GameCube and Wii disc image RVZ compression and decompression
//! benchmarked against DolphinTool.
...
/// Runs a `DolphinTool header` parse check on a rom-converto RVZ, as the
/// .md documents. Non-fatal: a failure is reported but does not drop results.
