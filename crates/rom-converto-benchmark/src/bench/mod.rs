//! Scratch-directory and file-lookup helpers shared by every per-platform
//! benchmark in [`crate::bench::chd`], [`crate::bench::ctr`],
//! [`crate::bench::disc`], and [`crate::bench::switch`].
...
/// under test, the directory counterpart tools may live in, and the run knobs.
pub struct BenchCtx {
