...
const psp: OpDef = {
	...
	subtitle:
		"Decrypts a PSN-distributed NPUMDIMG EBOOT.PBP, or the one inside a PSN .pkg, and writes the plain disc image.",
	dropText: "Drop an EBOOT.PBP or PSN .pkg file",
	acceptedExts: ["pbp", "pkg", ...ARCHIVE_EXTS],
	browseFilters: [{ name: "PBP or PKG", extensions: ["pbp", "pkg"] }],
