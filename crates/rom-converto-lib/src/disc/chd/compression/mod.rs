use crate::disc::cd::ecc::{has_valid_ecc, restore_sector_ecc, strip_sector_ecc};
use crate::disc::cd::{FRAME_SIZE, SECTOR_SIZE, SUBCODE_SIZE};
use crate::disc::chd::compression::cdfl::CD_SYNC_HEADER;
use crate::disc::chd::compression::huffman8::huffman8_encode;
use crate::disc::chd::compression::lzma::LzmaEncoder;
