...
use crate::disc::chd::compression::{ChdCodec, codec_header_slots};
use crate::disc::chd::compute_overall_sha1;
use crate::disc::chd::error::{ChdError, ChdResult};
use crate::disc::chd::map::{MapEntry, compress_v5_map};
...
use crate::disc::cue::models::CueSheet;
use crate::disc::laserdisc::avi::{AviFile, LdParams};
...
mod tests {
    use super::*;
    use crate::disc::chd::compression::default_dvd_codecs;
    use crate::disc::chd::compression::dvd::DvdDecoderSet;
    use crate::disc::chd::map::{COMPRESSION_NONE, COMPRESSION_SELF, decompress_v5_map};
    use crate::disc::chd::models::{CHD_METADATA_TAG_DVD, DVD_SECTOR_SIZE};
    use crate::disc::chd::reader::worker::resolve_entry;
    ...
    use crate::disc::chd::test_fixtures::mixed_iso;
    use crate::disc::chd::writer::worker::ld_audio_window;
    ...
    async fn convert_iso_to_chd_picks_hunk_size_by_console() {
        ...
        crate::disc::chd::convert_iso_to_chd(
            &NoProgress,
            ps2_path,
            ps2_out.clone(),
            crate::disc::chd::ChdOptions::default(),
            CancelToken::new(),
        )
        .await
        .unwrap();
        ...
        assert_eq!(header.hunk_bytes, crate::disc::chd::DVD_HUNK_BYTES_DEFAULT);
        assert_eq!(header.unit_bytes, DVD_SECTOR_SIZE);
        ...
        assert_eq!(header.hunk_bytes, crate::disc::chd::DVD_HUNK_BYTES_PSP);
    }
