...
use crate::sony::ps3::embedded_keys::embedded_key;
use crate::sony::ps3::error::{Ps3Error, Ps3Result};
use crate::sony::ps3::fs::read_plain_files;
use crate::sony::ps3::key::{self, Ps3Key};
use crate::sony::ps3::region::{Region, SECTOR_SIZE, parse_region_table};
use crate::sony::ps3::sfb::Sfb;
...
mod tests {
    use super::*;
    use crate::sony::ps3::fs::tests::{TINY_PNG, build_ps3_iso_with_icon};
