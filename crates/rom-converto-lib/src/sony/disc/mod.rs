//! PlayStation 1, 2, and PSP disc metadata (the `info` feature): what's on
//! the disc. [`crate::sony::psp`] holds the PSP PBP/EBOOT container format
//! instead: how the game is packaged.
//!
