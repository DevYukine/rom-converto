...
//!
//! The container itself is written and read through
//! [`crate::zar`], which the Xbox 360 pipeline shares; [`models`] holds
//! the Nintendo-specific ticket and TMD structures. The codename `wup`
//! matches the other Nintendo module folders (`ctr`, `rvl`, `rvz`,
//! `dol`).
