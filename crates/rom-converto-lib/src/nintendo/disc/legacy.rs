...
//!
//! [`compress_disc`]: crate::nintendo::disc::rvz::compress::compress_disc
...
mod tests {
    ...
    use crate::nintendo::disc::rvz::{compress_disc, decompress_disc};
    ...
    async fn dol_batch_skips_wia_and_migrates_the_rest() {
        ...
        assert!(!crate::nintendo::disc::rvz::derive_rvz_path(&wia).exists());
    }
