...
use crate::nintendo::disc::wbfs::usage::DiscUsage;
use crate::nintendo::disc::wbfs::writer::{build_block0, compute_layout};
...
mod tests {
    use super::*;
    use crate::nintendo::disc::wbfs::format::{WII_MAGIC, WII_MAGIC_OFFSET};
    use crate::nintendo::disc::wbfs::reader::WbfsReader;
    use crate::nintendo::disc::wbfs::usage::DiscUsage;
