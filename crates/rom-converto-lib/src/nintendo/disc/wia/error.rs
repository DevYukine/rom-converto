...
pub enum WiaError {
    ...
    #[error(transparent)]
    Rvz(#[from] Box<crate::nintendo::disc::rvz::error::RvzError>),
...
impl From<crate::nintendo::disc::rvz::error::RvzError> for WiaError {
    fn from(e: crate::nintendo::disc::rvz::error::RvzError) -> Self {
