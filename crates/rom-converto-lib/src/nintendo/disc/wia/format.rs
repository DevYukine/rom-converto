...
//! [`crate::nintendo::disc::rvz::format`]; only the 8-byte group descriptor
//! differs (RVZ adds `rvz_packed_size` for a 12-byte entry).
//!
//! [`WiaFileHead`]: crate::nintendo::disc::rvz::format::WiaFileHead
//! [`WiaDisc`]: crate::nintendo::disc::rvz::format::WiaDisc
//! [`WiaPart`]: crate::nintendo::disc::rvz::format::WiaPart
